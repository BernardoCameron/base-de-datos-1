...
--
-- Table structure for table `entidad_finaciera`
--

DROP TABLE IF EXISTS `entidad_finaciera`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `entidad_finaciera` (
  ...
  KEY `FK_entidad_financiera_paises` (`idPais`),
  CONSTRAINT `FK_entidad_financiera_paises` FOREIGN KEY (`idPais`) REFERENCES `paises` (`idpais`)
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `entidad_finaciera`
--

LOCK TABLES `entidad_finaciera` WRITE;
/*!40000 ALTER TABLE `entidad_finaciera` DISABLE KEYS */;
INSERT INTO `entidad_finaciera` VALUES (1,'BANCO DE GALICIA Y BUENOS AIRES S.A.U.','(11)990818020',1),(2,'BANCO DE LA NACION ARGENTINA','(11)269751586',1),(3,'BANCO DE LA PROVINCIA DE BUENOS AIRES','(11)690691870',1),(4,'INDUSTRIAL AND COMMERCIAL BANK OF CHINA','(11)120704079',1),(5,'CITIBANK N.A.','(11)550053879',1),(6,'BANCO BBVA ARGENTINA S.A.','(11)813199853',5),(7,'BANCO DE LA PROVINCIA DE CORDOBA S.A.','(11)638878215',5),(8,'BANCO SUPERVIELLE S.A.','(11)128023401',5),(9,'BANCO PATAGONIA S.A.','(11)930531316',5),(10,'BANCO HIPOTECARIO S.A.','(11)272891882',5),(11,'BANCO DE SAN JUAN S.A.','(11)686577601',5),(12,'BANCO MUNICIPAL DE ROSARIO','(381)596175062',5),(13,'BANCO SANTANDER ARGENTINA S.A.','(381)779760215',5),(14,'BANCO DEL CHUBUT S.A.','(381)693688778',5),(15,'BANCO DE SANTA CRUZ S.A.','(381)400740709',5),(16,'BANCO DE LA PAMPA SOCIEDAD DE ECONOMÍA M','(381)502500221',5),(17,'BANCO DE CORRIENTES S.A.','(381)190761855',5),(18,'BANCO PROVINCIA DEL NEUQUÉN SOCIEDAD ANÓ','(381)247597348',8),(19,'BANK OF CHINA LIMITED SUCURSAL BUENOS AI','(381)243657055',8),(20,'BRUBANK S.A.U.','(381)101024772',8),(21,'BANCO INTERFINANZAS S.A.','(388)186310513',8),(22,'HSBC BANK ARGENTINA S.A.','(388)124797160',8),(23,'OPEN BANK ARGENTINA S.A.','(388)734622177',8),(24,'JPMORGAN CHASE BANK, NATIONAL ASSOCIATIO','(388)116079007',8),(25,'BANCO CREDICOOP COOPERATIVO LIMITADO','(388)313650562',8),(26,'BANCO DE VALORES S.A.','(388)875269125',7),(27,'BANCO ROELA S.A.','(388)691313993',7),(28,'BANCO MARIVA S.A.','(341)737004016',7),(29,'BANCO ITAU ARGENTINA S.A.','(341)549984901',7),(30,'BNP PARIBAS','(341)743043742',7),(31,'BANCO PROVINCIA DE TIERRA DEL FUEGO','(341)477463034',7),(32,'BANCO DE LA REPUBLICA ORIENTAL DEL URUGU','(341)571667754',7),(33,'BANCO SAENZ S.A.','(341)864097517',9),(34,'BANCO MERIDIAN S.A.','(341)898424016',9),(35,'BANCO MACRO S.A.','(341)756451251',9),(36,'BANCO COMAFI SOCIEDAD ANONIMA','(341)417614692',9),(37,'BANCO DE INVERSION Y COMERCIO EXTERIOR S','(341)282496440',9),(38,'BANCO PIANO S.A.','(341)117896646',9),(39,'BANCO JULIO SOCIEDAD ANONIMA','(351)781316921',9),(40,'BANCO RIOJA SOCIEDAD ANONIMA UNIPERSONAL','(351)640432415',13),(41,'BANCO DEL SOL S.A.','(351)898274716',13),(42,'NUEVO BANCO DEL CHACO S. A.','(351)317538721',13),(43,'BANCO VOII S.A.','(351)675352526',13),(44,'BANCO DE FORMOSA S.A.','(351)574210966',13),(45,'BANCO CMF S.A.','(351)674185333',13),(46,'BANCO DE SANTIAGO DEL ESTERO S.A.','(351)164715333',13),(47,'BANCO INDUSTRIAL S.A.','(351)571619671',15),(48,'NUEVO BANCO DE SANTA FE SOCIEDAD ANONIMA','(351)675365710',15),(49,'BANCO CETELEM ARGENTINA S.A.','(11)548983338',15),(50,'BANCO DE SERVICIOS FINANCIEROS S.A.','(11)518484400',15),(51,'BANCO DE SERVICIOS Y TRANSACCIONES S.A.','(11)524695791',15),(52,'RCI BANQUE S.A.','(11)693612261',15),(53,'BACS BANCO DE CREDITO Y SECURITIZACION S','(11)431496612',15),(54,'BANCO MASVENTAS S.A.','(11)826266986',15),(55,'WILOBANK S.A.U.','(11)827460883',15),(56,'NUEVO BANCO DE ENTRE RÍOS S.A.','(11)992547453',15),(57,'BANCO COLUMBIA S.A.','(11)566527947',15),(58,'BANCO BICA S.A.','(11)113903536',15),(59,'BANCO COINAG S.A.','(11)592162057',15),(60,'BANCO DE COMERCIO S.A.','(11)966973268',15),(61,'BANCO SUCREDITO REGIONAL S.A.U.','(11)105118680',15),(62,'BANCO DINO S.A.','(11)154037884',15),(63,'FORD CREDIT COMPAÑIA FINANCIERA S.A.','(11)495592042',12),(64,'COMPAÑIA FINANCIERA ARGENTINA S.A.','(11)617608592',12),(65,'VOLKSWAGEN FINANCIAL SERVICES COMPAÑIA F','(11)605757820',12),(66,'IUDU COMPAÑÍA FINANCIERA S.A.','(11)627863156',12),(67,'FCA COMPAÑIA FINANCIERA S.A.','(341)549148049',19),(68,'GPAT COMPAÑIA FINANCIERA S.A.U.','(341)901600801',19),(69,'MERCEDES-BENZ COMPAÑÍA FINANCIERA ARGENT','(341)249932802',19),(70,'ROMBO COMPAÑÍA FINANCIERA S.A.','(351)841853991',19),(71,'JOHN DEERE CREDIT COMPAÑÍA FINANCIERA S.','(351)534485628',19),(72,'PSA FINANCE ARGENTINA COMPAÑÍA FINANCIER','(351)314932960',19),(73,'TOYOTA COMPAÑÍA FINANCIERA DE ARGENTINA','(351)298834005',19),(74,'NARANJA DIGITAL COMPAÑÍA FINANCIERA S.A.','(351)116492588',20),(75,'MONTEMAR COMPAÑIA FINANCIERA S.A.','(351)994779125',20),(76,'REBA COMPAÑIA FINANCIERA S.A.','(388)522966850',20),(77,'CREDITO REGIONAL COMPAÑIA FINANCIERA S.A','(388)936183242',20);
/*!40000 ALTER TABLE `entidad_finaciera` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pagos` (
  ...
  CONSTRAINT `FK_pago_tarjeta` FOREIGN KEY (`idtarjeta`) REFERENCES `tarjeta` (`idtarjeta`),
...
INSERT INTO `pagos` VALUES (1,500,0,1,NULL),(2,1252,9,3,1),(3,466,0,2,NULL),(4,3297,0,2,NULL),(5,3168,0,2,NULL),(6,2255,5,3,27),(7,2860,0,2,NULL),(8,2487,8,3,5),(9,1844,3,3,4),(10,3088,0,2,NULL),(11,1319,0,1,NULL),(12,567,9,3,39),(13,1347,0,2,NULL),(14,3438,0,1,NULL),(15,1836,9,3,26),(16,1309,0,2,NULL),(17,771,0,1,NULL),(18,1712,0,2,NULL),(19,1736,4,3,39),(20,1896,0,2,NULL),(21,2152,0,2,NULL),(22,1570,0,1,NULL),(23,2229,0,2,NULL),(24,1983,5,3,33),(25,1340,0,1,NULL),(26,2041,0,1,NULL),(27,3060,0,1,NULL),(28,2375,0,2,NULL),(29,1880,6,3,21),(30,1723,8,3,33),(31,639,0,1,NULL),(32,2664,0,1,NULL),(33,1478,9,3,50),(34,2908,0,1,NULL),(35,1813,4,3,1),(36,2258,7,3,8),(37,2397,8,3,3),(38,1218,0,2,NULL),(39,3212,0,1,NULL),(40,2960,0,1,NULL),(41,2815,3,3,26),(42,1377,0,2,NULL),(43,1192,4,3,11),(44,1869,0,1,NULL),(45,1349,0,2,NULL),(46,2314,7,3,27),(47,566,0,2,NULL),(48,1543,0,1,NULL),(49,3167,0,2,NULL),(50,3339,0,2,NULL),(51,354,0,2,NULL),(52,3312,0,1,NULL),(53,996,0,2,NULL),(54,2623,7,3,7),(55,1534,0,1,NULL),(56,3303,0,2,NULL),(57,3295,0,2,NULL),(58,816,0,2,NULL),(59,3025,0,2,NULL),(60,2458,0,1,NULL),(61,1929,0,1,NULL),(62,1743,3,3,15);
...
CREATE TABLE `tarjeta` (
  ...
  KEY `FK_tarjeta_entidad_financiera` (`identidad`),
  CONSTRAINT `FK_tarjeta_entidad_financiera` FOREIGN KEY (`identidad`) REFERENCES `entidad_finaciera` (`identidad`)
...
INSERT INTO `tarjeta` VALUES (1,'Agustin Rodriguez','4868886354221980','2029-09-21','311',20),(2,'Angela Liberatto','4391244370055840','2029-11-22','708',21),(3,'Carla Arrieta','3547255980853460','2027-01-07','902',22),(4,'Alegria Oro','6020517445683100','2029-02-07','307',23),(5,'Hernesto Esteban','7529266846593820','2028-03-27','608',24),(6,'Florencia Hoy','4793223076129800','2027-08-26','721',25),(7,'Andres Santoro','1474040040802000','2027-04-28','838',26),(8,'Marcos Orozco','9576607308468380','2026-11-08','865',51),(9,'Carolina Clavero','3020434541491160','2029-06-01','309',52),(10,'Maria Jose Arce','8940041745899660','2029-09-01','431',53),(11,'Franco Salcedo','1342017494733320','2027-11-18','119',54),(12,'Sergio Alderisi','2161390554102740','2026-02-04','122',55),(13,'Camila Altamira','8998306378610340','2028-06-13','898',55),(14,'Nora Pérez','5089159465947000','2027-06-27','478',55),(15,'Davolio Nancy','2471945778348360','2028-10-10','391',20),(16,'Fuller Andrew','5998705859645480','2028-03-06','113',20),(17,'Leverling Janet','6539934534155910','2026-01-10','207',25),(18,'Peacock Margaret','4981476648663940','2027-08-26','420',20),(19,'Buchanan Steven','7335470070919820','2029-08-03','386',62),(20,'Suyama Michael','8371357469681120','2026-05-24','374',62),(21,'Aldo Cruz','5918077150013980','2026-12-06','792',62),(22,'Cecilia Graneros','5844447967889090','2027-12-08','470',7),(23,'Lorena Ojeda','4123038576514760','2028-07-25','108',8),(24,'Sven Ottlieb','5210931644548930','2026-06-03','543',9),(25,'Janine Labrune','8892104804393180','2027-10-30','924',10),(26,'Maria Florencia Arce','8573193309913690','2026-07-12','125',11),(27,'Carlos Abrego','1079767876245080','2029-12-12','374',3),(28,'Aria Cruz','7743419032320790','2029-01-19','348',3),(29,'Diego Roel','6771318439422710','2026-06-07','270',3),(30,'Martine Raul','5754608301515780','2028-06-16','618',17),(31,'Maria Larsson','7238246090664960','2027-05-10','869',1),(32,'Peter Franken','4075533312708660','2027-08-03','438',1),(33,'Leandro Spadaro','9239811310769350','2028-11-09','261',19),(34,'Paolo Accorti','8794573365846860','2029-06-16','354',1),(35,'Lino Rodriguez','3450817364084380','2026-02-07','879',33),(36,'Eduardo Saavedra','2323947246512490','2027-12-21','256',34),(37,'Antonio del Valle Saavedra','5124333061525200','2029-06-09','177',35),(38,'Mayumi Ohno','2370229169398060','2028-05-25','567',36),(39,'Maria Sofia Castro','9583349971355930','2028-10-11','920',37),(40,'Peter Wilson','1990987172485260','2028-12-05','752',38),(41,'Lars Peterson','1610920953446280','2028-12-10','353',39),(42,'Carlos Diaz','9868769510971090','2026-06-14','128',40),(43,'Petra Winkler','7168227131634400','2026-04-20','216',40),(44,'Martin Bein','4715958486407910','2029-05-25','158',40),(45,'Sven Petersen','7306391753342700','2027-05-22','242',35),(46,'Elio Rossi','3213237805577750','2027-08-26','651',35),(47,'Beate Vileid','3854599127983730','2026-12-17','649',35),(48,'Jose Juarez','3978830309802800','2027-09-29','620',3),(49,'Nicolas Temkin','6791654486006620','2029-10-30','712',3),(50,'Pablo Bueno','5104907217145940','2029-03-25','103',3);
...
-- Dump completed on 2023-02-09 11:24:43
